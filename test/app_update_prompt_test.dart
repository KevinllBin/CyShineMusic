...
import 'package:cy_shine_music/features/update/app_update_prompt.dart';
...
void main() {
  ...
  const releaseUri =
      'https://github.com/KevinllBin/CyShineMusic/releases/tag/v1.1.0';
  ...
  testWidgets('newer release shows dialog and later does not open GitHub', (
    ...
    expect(find.textContaining('栖弦 1.1.0'), findsOneWidget);
  ...
  testWidgets('same release reports that the app is up to date', (
    ...
    final service = _FakeAppUpdateService(
      release: _release(
        version: '1.0.1',
        pageUri:
            'https://github.com/KevinllBin/CyShineMusic/releases/tag/v1.0.1',
      ),
    );
    final launchedUris = <Uri>[];
    AppUpdateCheckOutcome? outcome;
