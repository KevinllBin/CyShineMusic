...
class OnlinePlaylistKey {
  const OnlinePlaylistKey({required this.source, required this.id});
  ...
  bool operator ==(Object other) =>
      other is OnlinePlaylistKey && other.source == source && other.id == id;
...
final onlinePlaylistDetailProvider =
    FutureProvider.family<PlaylistInfo, OnlinePlaylistKey>((ref, key) {
      return ref
          .watch(musicApiProvider)
          .parsePlaylist(input: key.id, source: key.source);
    });
